<template>
    <div class="article-admin">
        <b-form class="pb-2">
            ...
            <b-form-group label="Descriçao:" label-for="article-description">
                <b-form-input
            ...
            <b-form-group v-if="mode === 'save'" label="Image (URL):" label-for="article-imageUrl">
                <b-form-input
                    ...
                    required
                    :readonly="mode === 'remove'"
                    placeholder="Informe a URL da Image...">
                </b-form-input>
            </b-form-group>
            <b-form-group v-if="mode === 'save'" label="Categories:" label-for="article-categoryId">
                <b-form-select 
